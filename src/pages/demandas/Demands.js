...
import DemandaRegisterPopup from "./DemandaRegisterPopup";
...
export const Demands = () => {
    ...
    const handleSaveDemand = (newDemand) => {
        ...
        setFilteredDemands((prev) => [...prev, newDemand]);
        setOpenPopup(false);
    };
        ...
        >
            ...
            >
                {filteredDemands.length === 0 ? (
                    ...
                    >
                        {searchValue ? 'Nenhum resultado encontrado' : 'Nenhuma demanda disponível'}
                    </Typography>
                ) : (
                    <DemandsTable
